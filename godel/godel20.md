...
[<em>Edited to add: In the 2 paragraphs below, I obviously don't mean that "the w word" has the canonical encodings of the mentioned machines, (as I said that letters prepresent canonical encodings of machines). I mean that "the w world" has all the information contained in those machines, and a way to act on that information so that within the w world, we see our A machine run.</em>]
